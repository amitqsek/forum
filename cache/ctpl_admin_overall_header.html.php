...
<title>CoinMage | <?php echo (isset($this->_rootref['PAGE_TITLE'])) ? $this->_rootref['PAGE_TITLE'] : ''; ?></title>
			...
			<div class="panel">
				<div id="content">
					...
					<div id="menu">
						...
						<p><?php echo ((isset($this->_rootref['L_LOGGED_IN_AS'])) ? $this->_rootref['L_LOGGED_IN_AS'] : ((isset($user->lang['LOGGED_IN_AS'])) ? $user->lang['LOGGED_IN_AS'] : '{ LOGGED_IN_AS }')); ?><br /><strong><?php echo (isset($this->_rootref['USERNAME'])) ? $this->_rootref['USERNAME'] : ''; ?></strong> [&nbsp;<a href="/logout"><?php echo ((isset($this->_rootref['L_LOGOUT'])) ? $this->_rootref['L_LOGOUT'] : ((isset($user->lang['LOGOUT'])) ? $user->lang['LOGOUT'] : '{ LOGOUT }')); ?></a>&nbsp;]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
						<ul>
