...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>The recommended way of updating your installation listed here is only valid for the automatic update package. You are also able to update your installation using the methods listed within the INSTALL.html document. The steps for updating forum automatically are:</p>
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			...
			<li>Upload the complete uncompressed install folder to your forum root directory (where your config.php file is).<br /><br /></li>
		</ul>
	...
	'VERSION_CHECK_EXPLAIN'			=> 'Checks to see if your forum installation is up to date.',
