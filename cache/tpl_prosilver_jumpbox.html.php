...
<?php } if ($this->_rootref['S_DISPLAY_JUMPBOX']) {  ?>
	...
	<?php } ?>
			...
			<input type="submit" value="<?php echo ((isset($this->_rootref['L_GO'])) ? $this->_rootref['L_GO'] : ((isset($user->lang['GO'])) ? $user->lang['GO'] : '{ GO }')); ?>" class="btn btn-primary btn-sm" />
		</fieldset>
	</form>
